...
<tr valign=top>
	<td>
	<table class=moduleBlue cellspacing=0 cellpading=2><tr><th colspan=4>Subscribers List - Total: <?=$total?></th> 
	<?=$pageNav ?>
<tr><td>
	...
	<?=$pageNav?></table></td>
	<td><form method=POST><div class=moduleBlue><h1>Subscriber Options</h1><div>
